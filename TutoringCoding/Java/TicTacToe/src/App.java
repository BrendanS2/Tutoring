...
public class App {
    ...
    public static char[][] userInput(char[][] bd, char marker){
        
        Scanner scam = new Scanner(System.in);
        System.out.print("What row do you want to put your Marker in? ");
        int rowInp = scam.nextInt();
        if(rowInp>2){
            System.out.print("Please Type in a valid Input less than 3>>");
            rowInp = scam.nextInt();
        }
        System.out.print("What column do you want to put your Marker in? ");
        int columnInp = scam.nextInt();
        if(columnInp>2){
            System.out.print("Please Type in a valid Input less than 3>>");
        ...
        bd[rowInp][columnInp] = marker;
        return bd; 
        // send updated board to main function
    }

    public static void print(char[][] bd) {
